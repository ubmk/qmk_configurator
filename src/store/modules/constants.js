...
*/
export const backend_keyboards = `${backend_baseurl}/keyboards`;
export const backend_keyboards_url = `${backend_baseurl}/keyboards.json`;
export const backend_compile_url = `${backend_baseurl}/compile`;
export const backend_status_url = `${backend_baseurl}/status.json`;
export const backend_readme_url_template = template(
  `${backend_keyboards}/<%= keyboard %>/readme.md`
);
